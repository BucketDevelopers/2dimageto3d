...
void cartoonifyImage(Mat srcColor, Mat dst, bool sketchMode, bool alienMode, bool evilMode, int debugType,int removenoise)
{
    ...
    if (!evilMode) {
        ...
        //removenoise was 80
        threshold(edges, mask, removenoise, 255, THRESH_BINARY_INV);
